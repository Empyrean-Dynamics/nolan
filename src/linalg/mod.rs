...
pub use generic::{
    ...
    mat_eigenvector_max, mat_inv, mat_log_det, mat_quadratic_form, mat_solve, mat_symmetric_eigen,
    mat_symmetrize, mat_trace, mat_trace_product, mat_vec_mul, vec_norm,
};
pub use mat3::{
